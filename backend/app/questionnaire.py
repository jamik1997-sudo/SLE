QUESTIONS = [
    ...
    {"key":"presentation_1","section":"Презентация","step":4,"weight":5.0,"allow_na":False,"text":"Выявляет потребность, задавая открытые и закрытые вопросы"},
    {"key":"presentation_2","section":"Презентация","step":4,"weight":5.0,"allow_na":False,"text":"Считает выгоду"},
    {"key":"presentation_3","section":"Презентация","step":4,"weight":5.0,"allow_na":False,"text":"Формирует предложение"},
    {"key":"objection_1","section":"Работа с возражениями","step":4,"weight":3.0,"allow_na":False,"text":"Выясняет, в чем суть возражения — конкретизация"},
    {"key":"objection_2","section":"Работа с возражениями","step":4,"weight":3.0,"allow_na":False,"text":"Частично соглашается с утверждением клиента — присоединение"},
    {"key":"objection_3","section":"Работа с возражениями","step":4,"weight":3.0,"allow_na":False,"text":"Повторяет или озвучивает дополнительные выгоды — аргументация"},
    {"key":"point_1","section":"Работа в точке","step":5,"weight":2.5,"allow_na":False,"text":"Проверяет рабочее состояние оборудования, освещение и наличие формы"},
    {"key":"point_2","section":"Работа в точке","step":5,"weight":2.5,"allow_na":False,"text":"Заполняет KO-карту в системе SMARTUP"},
    {"key":"point_3","section":"Работа в точке","step":5,"weight":2.5,"allow_na":False,"text":"Проверяет наличие и запас SIM-карт и при необходимости составляет заказ"},
    {"key":"point_4","section":"Работа в точке","step":5,"weight":2.5,"allow_na":False,"text":"Оценивает расположение плакатов и текущую планограмму"},
    ...
    {"key":"finish_visit_1","section":"Завершение визита","step":6,"weight":5.0,"allow_na":False,"text":"Использует правило 5П"},
